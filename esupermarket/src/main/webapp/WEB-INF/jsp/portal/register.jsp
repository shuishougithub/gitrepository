...
<head>
	...
	<link href="picture/favicon.ico" rel="icon" type="image/x-icon" />

	<link type="text/css" href="css/common.css" rel="stylesheet" />
	<link type="text/css" href="css/cm_www.css" rel="stylesheet" />
	<link type="text/css" href="css/new.main.css" rel="stylesheet" />
    ...
    $(function(){
       ...
       //2.验证密码是否相同
         ...
         $("#passwd2").blur(function(){
        	 if($(this).val().trim()!=$("#passwd1").val().trim()){
        		 $("#checkpwd1").text("确认密码必须与密码一致")
        		 return
        	 }
        	 $("#checkpwd1").text("")
         })
...
<div class="bd_bottom_ea">
	<div class="wrap pub_logo_box clearfix">
		<div class="pub_logo f_l"><a href="/home/index.html"><img alt="" src="picture/logo.png"></a></div>
		<div class="f_r">
			<ul class="sizeZero merchant_info_box">
				<li class="inline mg_l40 mg_t40">
					<span class="inline col_8c8">欢迎来到必要，请 </span><a class="col_8c8 inline mg_l5" href="javascript:void(0)">登录 </a><span class="col_8c8 mg_l5 mg_r5 inline">|</span><span class="col_8c8 inline">注册</span> 
				</li>
			</ul>
		</div>
	</div>
...
<div class="loginItem auto ">
	<input type="hidden"  id="returnUrl" value="biyao.jsp"/>
	<form method="post" action="customer/register.do" id="J_phone">
	<div class="loginBox">
		...
		<dl class="mg_t20">
			<dd class="inline mg_r5">
				<input  type="text" value="请输入您的手机号码" id="phone"  class="loginTxt w360 col_999 border" name="phone" data-type="mobile-number" maxlength="11"  />
				<input type="hidden" name="source" id="sourceID"/>
				<span id="checkPhone" class="checkspan" style="color: red"></span>
			</dd>
	        <dd class="J_validate inline col_f90"></dd>
		</dl>
		<dl class="mg_t20 sizeZero none" id="imgCodeDiv">
	   		<dd class="inline mg_r20"><input tip='请填写右侧的验证码' type="text" id="registImgCode" class="loginTxt w160 col_999" maxlength="4"/></dd>
	   		<dd class="inline mg_r20"><img src="picture/grey.gif" height="45" width="120" id="registImg" /></dd>
	   		<dd class="inline mg_r15"><a href="javascript:;" id="imgChange" class="col_999 unLine">看不清<br/>换一张</a></dd>
		...
		<dl class="mg_t20 none voiceCheck">
	   	...
	   	<dl class="mg_t20">
			<dd class="inline mg_r5">
				...
				<span id="checkpwd1" class="checkspan" style="color: red"></span>
			</dd>
		...
		<dd class="inline mg_r5">
			...
			<span id="checkpwd2" class="checkspan" style="color: red"></span>
		</dd>
...
<script src="js/registnew.js"></script>
