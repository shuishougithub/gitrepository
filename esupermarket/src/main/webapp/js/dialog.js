            ...
            setType: function(e) {
                ...
                switch (t("body").append(a.tempMark).append(a.tempMark2), a.oMark = t(".pop_mark_ifrmae[" + a.sings + "]"), a.oMark2 = t(".pop_mark[" + a.sings + "]"), e.type.toLowerCase()) {
                    ...
                    case "confirm":
                        ...
                        break;
                    case "image":
                        var n = '<div class="J_pop pop" id="' + e.id + '" ' + a.sings + '><div class="pop_hd"><span class="pop_close">关闭</span></div><div class="pop_bd"><span class="pop_prev">上一个</span><span class="pop_next">下一个</span><div class="pop_img"><div></div></div>';
                        t("body").append(n);
                        break;
                    default:
                        var n = '<div class="J_pop pop" id="' + e.id + '" ' + a.sings + '><div class="pop_hd"><span class="pop_close">关闭</span></div><div class="pop_bd"></div></div>';
                        t("body").append(n)
                }
            },
